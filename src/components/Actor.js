      ...
      <div class="row">
                ...
                <div class="col-lg-6 px-xl-10">
                  ...
                  <ul class="list-unstyled mb-1-9">
                    <li class="mb-2 mb-xl-3 display-28">
                      <span class="display-26 text-secondary me-2 font-weight-600">Position:</span> Coach
                    </li>
        ...
        <div class="col-lg-12 mb-4 mb-sm-5">
          <div>
            ...
            <p>Edith istype specimen book.</p>
          ...
          <div class="row">
            <div class="col-lg-12 mb-4 mb-sm-5">
              <div class="mb-4 mb-sm-5">
                ...
                <div class="custom-progress progress progress-medium mb-3" style={{height: 4}}>
                ...
                <div class="custom-progress progress progress-medium" style={{height: 4}}>
              ...
              <div>
                ...
                <p class="mb-1-9">There are many variations of pa</p>
              </div>
            </div>
          </div>
        </div>
